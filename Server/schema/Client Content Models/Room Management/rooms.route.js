...
// add rooms
router.post('/admin/add-rooms', protect, authorize('admin'), upload.single('roomImage'), addRooms);
// Update Room Details
router.put('/admin/update-room-details/:roomId', protect, authorize('admin'), upload.single('roomImage'), updateRoomDetails);
// get rooms
